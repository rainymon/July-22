...
# - 1·6·100·162·176번은 본문 카드가 확대됩니다.
# - 전체 길이는 약 58초입니다.
#
# 조작
# R: 처음부터 다시 시작
...
# -------------------------------------------------------------------
BODY_TEXTS = {
    1: "[1번 기사 본문 또는 본문 발췌를 여기에 붙여넣으세요.]",
    6: "[6번 기사 본문 또는 본문 발췌를 여기에 붙여넣으세요.]",
    100: "[100번 기사 본문 또는 본문 발췌를 여기에 붙여넣으세요.]",
    162: "[162번 기사 본문 또는 본문 발췌를 여기에 붙여넣으세요.]",
    176: "[176번 기사 본문 또는 본문 발췌를 여기에 붙여넣으세요.]",
}
...
(() => {
  ...
  function processEvents() {
    while (nextIndex < events.length && events[nextIndex].eventTime <= activeElapsed) {
      ...
      } else if (article.num === 6 || article.num === 100 || article.num === 162) {
